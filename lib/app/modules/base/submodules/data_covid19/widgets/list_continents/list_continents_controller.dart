...
abstract class _ListContinentsControllerBase with Store {
  final IDataCovid19Repository repository2;
  // ignore: type_init_formals
  _ListContinentsControllerBase(IDataCovid19Repository this.repository2) {
    getAllContinents();
  }
  ...
  Future<void> getAllContinents() async {
    ...
    try {
      final response = await repository2.getAllContinents();
